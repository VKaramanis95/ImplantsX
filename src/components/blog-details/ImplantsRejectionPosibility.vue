                ...
                <div class="col-lg-8 col-md-12">
                    <div class="blog-details-desc">
                        <div class="article-image">
                            <img src="../../assets/images/blog/implants-rejection-possibility/rejection_main.webp" alt="image">
                        ...
                        <div class="article-content">
                            <div class="row">
                                ...
                                <h2><u>{{ $t('blog_main_implants_rejection_possibility_title') }}</u></h2>
                                <p>{{ $t('blog_main_implants_rejection_possibility_p') }}</p>
                                <p>
                                    <ol>
                                        <li>
                                            {{ $t('blog_main_implants_rejection_possibility_li1') }}
                                        </li>
                                        <li>
                                            {{ $t('blog_main_implants_rejection_possibility_li2') }}
                                        </li>
                                    </ol>
                                </p>

                                <p>{{ $t('blog_main_implants_rejection_possibility_p1') }}</p>
                                <p>
                                    <ol>
                                        <li>
                                            {{ $t('blog_main_implants_rejection_possibility_li3') }}
                                        </li>
                                        <li>
                                            {{ $t('blog_main_implants_rejection_possibility_li4') }}
                                        </li>
                                        <li>
                                            {{ $t('blog_main_implants_rejection_possibility_li5') }}
                                        </li>
                                    </ol>
                                </p>
...
export default {
    name: 'ImplantsRejectionPosibility',
    components: {
        BlogSidebar
    },
        mounted() {
