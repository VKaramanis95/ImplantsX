                ...
                <div class="col-lg-8 col-md-12">
                    <div class="blog-details-desc">
                        <div class="article-image">
                            <img src="../../assets/images/blog/mouth-smell/mouth_smell_main_page.webp" alt="image">
                        ...
                        <div class="article-content">
                            <div class="row">
                                ...
                                <h2><u>{{ $t('blog_mouth_smell_title') }}</u></h2>
                                <p>{{ $t('blog_mouth_smell_p') }}</p>
                                <p>{{ $t('blog_mouth_smell_p1') }}</p>
                                <p>
                                    <ol>
                                        <li>
                                            {{ $t('blog_mouth_smell_li') }}
                                        </li>
                        
                                        <li>
                                            {{ $t('blog_mouth_smell_li1') }}
                                        </li>  
                                        <li>
                                            {{ $t('blog_mouth_smell_li2') }}
                                        </li>          
                                    </ol>
                                </p>
                                <p>{{ $t('blog_mouth_smell_p2') }}</p>
