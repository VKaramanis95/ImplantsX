    ...
    data() {
      return {
        images: [
          ...
          { url: require('@/assets/images/OurClinic/gallery/11.webp'), alt: 'Slide 6' },
          { url: require('@/assets/images/OurClinic/gallery/12.webp'), alt: 'Slide 7' },
          { url: require('@/assets/images/OurClinic/gallery/1.webp'), alt: 'Slide 8' },
          { url: require('@/assets/images/OurClinic/gallery/4.webp'), alt: 'Slide 9' },
          { url: require('@/assets/images/OurClinic/gallery/5.webp'), alt: 'Slide 10' },
          { url: require('@/assets/images/OurClinic/gallery/7.webp'), alt: 'Slide 11' },
          { url: require('@/assets/images/OurClinic/gallery/8.webp'), alt: 'Slide 12' },
          { url: require('@/assets/images/OurClinic/gallery/13.webp'), alt: 'Slide 13' },
          { url: require('@/assets/images/OurClinic/gallery/15.webp'), alt: 'Slide 14' },
          { url: require('@/assets/images/OurClinic/gallery/22.webp'), alt: 'Slide 15' },
