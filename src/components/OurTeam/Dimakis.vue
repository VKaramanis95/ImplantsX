            ...
            <div class="row align-items-center">
                <div class="col-lg-5 col-md-6">
                    <div class="dentist-details-image">
                        <img src="../../assets/images/OurTeam/dimakis/dimakis_allteam.webp" alt="image">
                    </div>
                </div>
                ...
                <div class="col-lg-7 col-md-6">
                    <div class="dentist-details-content">
                        ...
                        <div class="content-overview">
                            <div class="content-overview">
                            <p class="glide-in"><b>{{ $t('general_birthday_title') }}</b> {{ $t('dimakis_birthday') }}</p>

                            <p class="glide-in"><b>{{ $t('general_specialized_title') }}</b> {{ $t('dimakis_specialized') }}</p>

                            <p class="glide-in"><b>{{ $t('general_education_title') }}</b> {{ $t('dimakis_education') }}</p>
                            
                            <p class="glide-in"><b>{{ $t('general_member_title') }}</b> {{ $t('dimakis_member') }}</p>
                        
                        </div></div>
                    </div>
                </div>
                <div class="dentist-details-overview-content">
                    <p class="glide-in">{{ $t('dimakis_summary') }}</p>
                </div>
            </div>
        </div>
    </div>
