            ...
            <div class="row align-items-center">
                <div class="col-lg-5 col-md-6">
                    <div class="dentist-details-image">
                        <img src="../../assets/images/OurTeam/iliopoulou/iliopoulou_allteam.webp" alt="image">
                    </div>
                </div>
                ...
                <div class="col-lg-7 col-md-6">
                    <div class="dentist-details-content">
                        <h3>
                            <router-link to="/iliopoulou">
                                {{ $t('our_team_iliopoulou') }}
                            </router-link>
                        </h3>
                        <span>{{ $t('all_staff_iliopoulou_spec') }}</span>
                        ...
                        <div class="content-overview">
                            <div class="content-overview">
                            <p class="glide-in"><b>{{ $t('general_birthday_title') }}</b> {{ $t('iliopoulou_birthday') }}</p>
                ...
                <div class="dentist-details-overview-content">
                    <p class="glide-in">{{ $t('iliopoulou_summary') }}</p>
                </div>
            </div>
        </div>
    </div>
