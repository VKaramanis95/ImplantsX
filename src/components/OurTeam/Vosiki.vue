            ...
            <div class="row align-items-center">
                <div class="col-lg-5 col-md-6">
                    <div class="dentist-details-image">
                        <img src="../../assets/images/OurTeam/voziki/voziki_team.webp" alt="image">
                    </div>
                </div>
                ...
                <div class="col-lg-7 col-md-6">
                    <div class="dentist-details-content">
                        <h3>
                            <router-link to="/vosiki">
                                {{ $t('our_team_vosiki') }}
                            </router-link>
                        </h3>
                        <span>{{ $t('all_staff_vosiki_spec') }}</span>
                        ...
                        <div class="content-overview">
                            <div class="content-overview">
                            <p class="glide-in"><b>{{ $t('general_birthday_title') }}</b> {{ $t('vosiki_birthday') }}</p>

                            <p class="glide-in"><b>{{ $t('general_specialized_title') }}</b> {{ $t('vosiki_specialized') }}</p>
                ...
                <div class="dentist-details-overview-content">
                    <p class="glide-in">{{ $t('vosiki_summary') }}</p>
                </div>
            </div>
        </div>
    </div>
