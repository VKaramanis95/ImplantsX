            ...
            <div class="row">
                <div class="col-lg-8 col-md-12">
                    <div class="services-details-image">
                        <img src="../../assets/images/services/facial-aesthetics/prp-therapy/prp-main-page.webp" alt="image">
                    </div>

                    <div class="services-details-content">
                        <u><h3>{{ $t('prp_title') }}</h3></u>
                        <p>{{ $t('prp_p1') }}</p> 
                        <p>{{ $t('prp_p2') }}</p> 
                    </div>
                </div>
...
import BlogSidebarImplants from '../../components/services-sidebars/BlogSidebarImplants.vue';
    ...
    export default {
        ...
        mounted() {
            ...
            const servicesDetailsAreaBottom = servicesDetailsArea.getBoundingClientRect().bottom + window.scrollY - sidebar.offsetHeight - 180; // Adjust 100 to stop earlier
