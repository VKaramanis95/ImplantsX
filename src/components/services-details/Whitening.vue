            ...
            <div class="row">
                <div class="col-lg-8 col-md-12">
                    <div class="services-details-image">
                        <img src="../../assets/images/services/whitening/whitening-page-bg.webp" alt="image">
                    </div>

                    <div class="services-details-content">
                        <u><h3>{{ $t('whitening_page_title') }}</h3></u>
                        <p>{{ $t('whitening_page_p') }}</p>
                        <p>{{ $t('whitening_page_p1') }}</p>
                    </div>
                    
                    <div class="services-details-content">
                        <u><h3>{{ $t('whitening_page_what_title') }}</h3></u>
                        <p> {{ $t('whitening_page_what_p') }}</p>
                    ...
                    <div class="services-details-content">
                        <u><h3>{{ $t('whitening_page_safe_title') }}</h3></u>
                        <p >{{ $t('whitening_page_safe_p') }}</p>
                    </div>
