            ...
            <div class="row">
                <div class="col-lg-8 col-md-12">
                    <div class="services-details-image">
                        <img src="../../assets/images/services/resin-veneers/veneers_resin_page.webp" alt="image">
                    </div>

                    

                    <div class="services-details-content">
                        <h2>{{ $t('veneers_resin_page_general_title') }}</h2>
                        <u><h3>{{ $t('veneers_resin_page_when_title') }}</h3></u>
                        <p>{{ $t('veneers_resin_page_when_p') }}</p>
                        <p>{{ $t('veneers_resin_page_when_p1') }}</p>
                        
                    </div>

                    <div class="services-details-content">
                        <u><h3>{{ $t('veneers_resin_page_procedure_title') }}</h3></u>
                        <p >{{ $t('veneers_resin_page_procedure_p') }}</p>
                    </div>
                    ...
                    <div class="services-details-content">
                        <u><h3>{{ $t('veneers_resin_page_longevity_title') }}</h3></u>
                        <p >{{ $t('veneers_resin_page_longevity_p') }}</p>
