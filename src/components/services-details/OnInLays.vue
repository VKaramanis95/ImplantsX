            ...
            <div class="row">
                <div class="col-lg-8 col-md-12">
                    <div class="services-details-image">
                        <img src="../../assets/images/services/inonlays/inonlay_main_page.webp" alt="image">
                    </div>

                    <div class="services-details-content">
                        
                        <u><h3>{{ $t('prosthetics_lays_main_page_title') }}</h3></u>
                        <p>{{ $t('prosthetics_lays_main_page_p') }}</p>
                        
                    </div>
                    

                    <div class="services-details-content">
                        <u><h3>{{ $t('prosthetics_lays_main_page_what_title') }}</h3></u>
                        <p >{{ $t('prosthetics_lays_main_page_what_p') }}</p>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6">
                                <div class="single-gallery">
                                    <img src="../../assets/images/services/inonlays/milena.webp" alt="image">
                                </div>
                            </div>
                    ...
                    <div class="services-details-content">
                        <u><h3>{{ $t('prosthetics_lays_main_page_procedure_title') }}</h3></u>
                            <p>{{ $t('prosthetics_lays_main_page_procedure_p') }}</p>
                    </div>
...
import BlogSidebarImplants from '../../components/services-sidebars/BlogSidebarImplants.vue';
    ...
    export default {
        ...
        mounted() {
            ...
            const servicesDetailsAreaBottom = servicesDetailsArea.getBoundingClientRect().bottom + window.scrollY - sidebar.offsetHeight - 130; // Adjust 100 to stop earlier
