            ...
            <div class="row">
                <div class="col-lg-8 col-md-12">
                    <div class="services-details-image">
                        <img src="../../assets/images/services/facial-aesthetics/face-improvement/face_main_page.webp" alt="image">
                    </div>

                    <div class="services-details-content">
                        <u><h3>{{ $t('face_improvement_title') }}</h3></u>
                        <p>{{ $t('face_improvement_p') }}</p>
                    </div>
                    ...
                    <div class="services-details-content">
                        <u><h3>{{ $t('face_improvement_technic_title') }}</h3></u>
                        <p> {{ $t('face_improvement_technic_p') }}</p>
                        <ol>
                                <li>
                                     {{ $t('face_improvement_technic_li_1') }}
                                </li>
                                <li>
                                     {{ $t('face_improvement_technic_li_2') }}
                                </li>
