            ...
            <div class="row">
                <div class="col-lg-8 col-md-12">
                    <div class="services-details-image">
                        <img src="../../assets/images/services/bridges/dental-bridges-bg.webp" alt="image">
                    </div>

                    <div class="services-details-content">
                        <u><h3>{{ $t('zirconia_bridges_title') }}</h3></u>
                        <p>{{ $t('zirconia_bridges_p') }}</p>
                        <p>{{ $t('zirconia_bridges_p1') }}</p>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6">
                                <div class="single-gallery">
                                    <img src="../../assets/images/services/bridges/patient1.webp" alt="image">
                                </div>
                            </div>
