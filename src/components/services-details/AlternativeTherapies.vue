            ...
            <div class="row">
                <div class="col-lg-8 col-md-12">
                    <div class="services-details-image">
                        <img src="../../assets/images/services/facial-aesthetics/alternative-ways/aisthitikos-velonismos-main.webp" alt="image">
                    </div>

                    <div class="services-details-content">
                        <u><h3>{{ $t('alternative_therapies_title') }}</h3></u>
                        <p>{{ $t('alternative_therapies_p') }}</p> 
                    </div>
                    <div class="services-details-content">
                        <u><h3>{{ $t('alternative_therapies_rejuvance_title') }}</h3></u>
                        <p>{{ $t('alternative_therapies_rejuvance_p') }}</p> 
                    </div>
                </div>
