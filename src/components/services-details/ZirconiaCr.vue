            ...
            <div class="row">
                <div class="col-lg-8 col-md-12">
                    ...
                    <div class="services-details-content">
                        <u><h3>{{ $t('zirconia_crowns_title') }} </h3></u>
                        <p>{{ $t('zirconia_crowns_p') }}</p>
                        <p>{{ $t('zirconia_crowns_p1') }}</p>
                    </div>

                    <div class="services-details-content">
                        <u><h3>{{ $t('zirconia_crowns_appointment_title') }}</h3></u>
                        <p >{{ $t('zirconia_crowns_appointment_p') }}</p>  
                        <p>
                            <ol>
                                <li>
                                    <p>{{ $t('zirconia_crowns_appointment_li1') }}</p>
                                </li>
                                <li>
                                    <p>{{ $t('zirconia_crowns_appointment_li2') }}</p>
                                </li>
                                <li>
                                    <p>{{ $t('zirconia_crowns_appointment_li3') }}</p>
                                </li>
                                <li>
                                    <p>{{ $t('zirconia_crowns_appointment_li4') }}</p>
                                </li>
                                <li>
                                    <p>{{ $t('zirconia_crowns_appointment_li5') }}</p>
                                </li>
                                <li>
                                    <p>{{ $t('zirconia_crowns_appointment_li6') }}</p>
                                </li>
