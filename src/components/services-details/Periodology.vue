            ...
            <div class="row">
                <div class="col-lg-8 col-md-12">
                    <div class="services-details-image">
                        <img src="../../assets/images/services/periodology/periodology_main_page.webp" alt="image">
                    </div>

                    <div class="services-details-content">
                        <u><h3>{{ $t('periodology_services_title') }}</h3></u>
                        <p>{{ $t('periodology_p1') }}</p>
                        <p>{{ $t('periodology_p2') }}</p>
                        <p>{{ $t('periodology_p3') }}</p>
