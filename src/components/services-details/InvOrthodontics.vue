            ...
            <div class="row">
                <div class="col-lg-8 col-md-12">
                    <div class="services-details-image">
                        <img src="../../assets/images/services/invisible-orthodontics/invisibleOrthodontics-main_page.webp" alt="image">
                    </div>

                    <div class="services-details-content">
                        <u><h3>{{ $t('invisible_orthodontics_page_title') }}</h3></u>
                        <p>{{ $t('invisible_orthodontics_page_p') }}</p>
                        <p>{{ $t('invisible_orthodontics_page_p1') }}</p>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6">
                                <div class="single-gallery">
                                    <img src="../../assets/images/services/invisible-orthodontics/patient1.webp" alt="image">
                    ...
                    <div class="services-details-content">
                        <u><h3>{{ $t('invisible_orthodontics_page_advantages_title') }}</h3></u>
                        <p>{{ $t('invisible_orthodontics_page_p') }}</p>
                        <div class="row">
                            <div class="col-lg-6 col-md-6">
                                <ul >
                                    ...
                                    <li>
                                        {{ $t('invisible_orthodontics_page_advantages_li_2') }}
                                    </li>
                                    
                                    <li>
                                        {{ $t('invisible_orthodontics_page_advantages_li_3') }}
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="col-lg-6 col-md-6">
                                <ul>
                                    <li>
                                            {{ $t('invisible_orthodontics_page_advantages_li_1') }}
                                    </li>
                                    
                                    <li>
                                        {{ $t('invisible_orthodontics_page_advantages_li_4') }}
                                    </li>
                    ...
                    <div class="services-details-content">
                        <u><h3>{{ $t('invisible_orthodontics_page_procedure_title') }}</h3></u>
                        
                            <p>{{ $t('invisible_orthodontics_page_procedure_title_p') }}</p>
                    </div>
...
import BlogSidebarImplants from '../../components/services-sidebars/BlogSidebarImplants.vue';
    ...
    export default {
        ...
        mounted() {
            ...
            const servicesDetailsAreaBottom = servicesDetailsArea.getBoundingClientRect().bottom + window.scrollY - sidebar.offsetHeight - 105; // Adjust 100 to stop earlier
